...
{
    debug_print("[ DEBUG ]\n\n");
    debug_print("Press TRIANGLE to make the background color white\n");
    debug_print("SQUARE for red color\n");
    debug_print("CROSS for green color\n");
    debug_print("CIRCLE for blue color\n");
    debug_print("L TRIGGER to print a text\n");
}
...
int main(void)
{
    ...
    while (isRunning())
    {
        ...
        {
            debug_print("You pressed L TRIGGER\n");
        }
    }
